...
function initialize() {
    ...
    + '<div class="map-title">' 
    + '<div class="brand" href="#"><img alt="" src="images/brand.png"><div class="brand-info"><div class="brand-name">Nikki Bisiker</div><div class="brand-text">architecture</div></div></div></div>' 
    + '<p class="map-address">'
    ...
    /*marker = new google.maps.Marker({
        map: map,
        draggable: true,
        title: 'Nikki Bisiker', //change title here
